  ...
  return (
    ...
    >
      ...
      <div className="flex shrink-0 items-baseline gap-3">
        <span className="text-4xl font-medium text-foreground/30 sm:text-5xl">{step.number}</span>
        <h3 className="text-xl font-semibold tracking-tight text-foreground sm:text-2xl">{step.label}</h3>
      </div>

      <div className="overflow-hidden">
        <p className="text-sm leading-relaxed font-medium text-foreground/70 opacity-100 translate-y-0 transition-all duration-500 ease-out sm:text-base lg:opacity-0 lg:translate-y-3 lg:group-hover:opacity-100 lg:group-hover:translate-y-0">
          {step.description}
        </p>
      </div>
    </article>
