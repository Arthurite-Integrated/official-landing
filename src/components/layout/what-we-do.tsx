    ...
    <section aria-labelledby={SECTION_TITLE_ID} className="relative isolate overflow-hidden bg-background px-5 py-24 sm:px-8 lg:py-32">
      ...
      <div className="mx-auto max-w-6xl">
        <header className="max-w-2xl">
          <p className="text-xs font-semibold tracking-[0.28em] text-foreground/50 uppercase">What we do</p>
          <h2 id={SECTION_TITLE_ID} className="mt-5 text-4xl leading-[1.06] font-medium tracking-tight text-foreground sm:text-5xl">
