...
function SectionFooterNotes() {
  return (
    <ul className="mt-8 space-y-1.5 text-xs text-foreground/50">
...
export function ServicesFeatureCompare() {
  ...
  return (
    <section aria-labelledby={SECTION_TITLE_ID} className="bg-background px-5 py-20 sm:px-8 lg:py-28">
      <div className="mx-auto max-w-5xl">
        <div className="text-center">
          <p className="text-xs font-semibold tracking-[0.28em] text-foreground/50 uppercase">Feature Breakdown</p>
          <h2 id={SECTION_TITLE_ID} className="mt-4 text-4xl font-medium tracking-tight text-foreground sm:text-5xl">
